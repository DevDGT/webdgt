                        ...
                        <a href="<?php echo base_url('/news/' . $news->slug); ?>">
                            <article class="entry" id="<?php echo $news->id; ?>">
                                <div class="entry-img coverGan h-100">
                                    <img src="<?php echo base_url('/uploads/cover/' . $news->cover); ?>" alt="cover" class="img-fluid" style="object-fit: cover; margin: auto; display: block;">
                                </div>
                ...
                <div class="blog-pagination w-100">
                    <div class="pagination d-flex justify-content-center">
                        <li class="btn <?php echo $page['current'] == 1 ? 'disabled' : ''; ?>">
                            <a href="<?php echo str_replace('#page', (intval($page['current']) - 1), $page['url']); ?>">Back</a>
                        </li>
                        <li class="btn disabled">
                            <a href="#"><?php echo $page['current']; ?></a>
                        </li>
                        <li class="btn <?php echo $page['next'] == 0 ? 'disabled' : ''; ?>">
                            <a class="disabled" href="<?php echo str_replace('#page', (intval($page['current']) + 1), $page['url']); ?>">Next
