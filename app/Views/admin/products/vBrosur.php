        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="float-right ml-3">
                    <button class="btn btn-sm btn-primary" id="btnAdd" title="Brosur Baru">
                        <i class="fas fa-user-plus mr-1"> </i>Baru
                    </button>
                </div>
                <table id="listBrosur" class="table table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Title</th>
...
<?= $this->endSection() ?>
<?= $this->section('js') ?>
<script src="<?= base_url('assets/js/page/admin/brosur.js') ?>" defer></script>
<?= $this->endSection() ?>