...
class CategoryCareer extends BaseController
{
    public function __construct()
    {
        $this->req = \Config\Services::request();
        $this->table = 'category_career';
    ...
    public function index()
    {
        // echo "Asdasd";
        $data = [
            'title' => 'Kategori Karir',
            'menu' => 'master',
            'subMenu' => 'category-career',
            'roti' => [
                'Home:blank' => base_url(),
                'Dashboard' => base_url(ADMIN_PATH . '/dashboard'),
                'Master' => '',
                'Kategori Karir:active' => '',
            ],
        ];

        return View('admin/category/vCategoryCareer', $data);
    }
