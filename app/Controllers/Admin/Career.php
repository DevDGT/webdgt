...
class Career extends BaseController
{
    ...
    public function index()
    {
        ...
        return View('admin/career/vCareer', $data);
    }
    ...
    public function store()
    {
        try {
            ...
            $categoryId = $this->db->table('category_career')->select('id')->where([EncKey('id') => Input_('id_category_career')])->get()->getRow()->id;
            $validate['data']['id_category_career'] = $categoryId ?? 0;
    ...
    public function update()
    {
        try {
            ...
            if ($_FILES['icon']['size'] > 0) {
                ...
                if ($iconOld != "") {
                    $path = FILESDIR . '/uploads/careers/' . $iconOld;
    ...
    public function delete()
    {
        try {
            ...
            if ($iconOld != '') {
                $path = ROOTPATH.'public/uploads/careers/'.$iconOld;
                if (file_exists($path)) {
                    unlink($path);
                }
            }
