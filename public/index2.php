        ...
        <div class="container aos-init aos-animate" data-aos="fade-up">
                ...
                <div class="col-lg-6 col-md-4 d-flex justify-content-center aos-init aos-animate mt-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box iconbox-blue">
                        <div class="container">
                            ...
                            <div class="text-wrap p-4" style="width: 25rem;">
                                <p>Provides expert advice on how best to use IT in achieving your business objectives</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-12 d-flex justify-content-center">
                    <a href="<?php echo base_url('/assets/compro/id.pdf'); ?>" target="_blank"><button class="btn btn-primary ">Download Company Profile</button></a>
                </div>
            </div>
        </div>
    </section>
        ...
        $(document).ready(function() {
            setTimeout(() => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) return window.open("<?php echo base_url('/assets/compro/id.pdf'); ?>")
                })
            }, 3000);
        })
    </script>
