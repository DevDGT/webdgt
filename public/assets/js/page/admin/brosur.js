CURRENT_PATH = ADMIN_PATH + "/products-brosur/";
...
$(document).ready((function () {
	...
	table = $(tableId).DataTable({
		...
		order: [],
		ajax: {
			url: API_PATH + "data/products-brosur",
			type: "POST",
			data: {
				_token: TOKEN
			},
	...
	let id = $(this).data("id");
	$.ajax({
		url: API_PATH + "row/products-brosur/" + id,
		type: "post",
		data: {_token: TOKEN},
		dataType: "json",
		beforeSend: function() {
			...
			addFormInput("#formBody", [{
                ...
                type: "file",
                name: "brosur",
                label: "File Brosur (*.pdf) (pilih jika ingin merubah)"
            }])
		}, 
		complete: function() {
			enableButton()
